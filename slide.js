...
const sliderFun = function() {
    const sliderContent = [
        ...
        },
        {
            ...
            skillImagePath: './img/python-symbol.png'
        },
        {
            skillName: 'Java',
        ...
        {
            skillName: 'Php',
            skillInfo: 'PHP is an open-source, server-side general scripting language that has now become a de-facto coding standard in the web development industry. It can be learned easily, and if one is from a coding background, he (or she) will find it very simple.',
            skillImagePath: './img/PHP.png'
        },
        {
            skillName: 'HTML/CSS',
